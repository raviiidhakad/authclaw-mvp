...
from app.api.v1.endpoints import (
    ...
    remediation, trust, reports, evidence_packages, risk,
)
...
api_router.include_router(providers.router, prefix="/gateway/providers", tags=["Gateway Providers"])
api_router.include_router(gateway_routes.router, prefix="/gateway/routes", tags=["Gateway Routes"])
api_router.include_router(api_keys.router, prefix="/gateway/api-keys", tags=["Gateway API Keys"])
...
api_router.include_router(risk.router, prefix="/risk", tags=["Risk & Red Teaming"])
